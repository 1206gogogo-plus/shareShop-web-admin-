    ...
    <div class="home-container">
        ...
        <div>
            <el-table ref="productTable"
                ...
                <el-table-column label="总销量" prop="dayTotalMoney" sortable  align="center">
                    
                </el-table-column> 
                <el-table-column label="seller销量" prop="daySellerMoney" sortable  align="center">
                </el-table-column> 
                <!-- <el-table-column label="商品库存" prop="dayCost" sortable width="160" align="center"> 
                </el-table-column> -->
                <el-table-column label="操作" width="100" align="center">
                    <template slot-scope="scope">       
                        <el-button
                            type="text"
                            size="mini"
                            @click="ProductDayDetail(scope.$index, scope.row)">详情
                        </el-button>                 
                    </template>
                </el-table-column> 
            </el-table>
        ...
        <div class="bottom-form">
            <el-form :inline="true" size="small" ref="productCateFrom">
                ...
                <el-button type="primary" style="margin-left:10px;" size="small" @click="handleSearchList()">查询</el-button>
                <el-button type="primary" style="margin-left:10px;" size="small" >导出</el-button> 
            </el-form> 
        </div>
        <div>
            <el-table ref="productTable"
                ...
                <el-table-column label="操作" width="100" align="center">
                    <template slot-scope="scope">       
                        <el-button
                            type="text"
                            size="mini"
                            @click="ProductMonthDetail(scope.$index, scope.row)">详情
                        </el-button>                 
                    </template>
                </el-table-column> 
            </el-table>
...
export default{
    ...
    methods:{
        ...
        ProductDayDetail(){
            this.$router.push({path:'/statistics/product/list_productDetail'});
        },

        //
        ProductMonthDetail(){
            this.$router.push({path:'/statistics/product/list_productByMonth'});
        },
