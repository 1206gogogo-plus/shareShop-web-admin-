    ...
    <div>
        ...
        <div>
            <el-table ref="productTable"
                ...
                <!-- <el-table-column label="月份" sortable  width="120" prop="month" align="center">
                </el-table-column> -->
                <!-- <el-table-column label="商品总销量" prop="totalSale" sortable align="center">
                
                </el-table-column>
                <el-table-column label="seller分销量" prop="sellerSale" sortable align="center">
...
export default{
    ...
    methods:{
        ...
        productDayDetail(){
            this.$router.push({path:'/statistics/product/list_productByDay'});
        },
