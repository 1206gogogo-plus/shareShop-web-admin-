<template> 
  <div class="app-container">
    ...
    <el-table-column label="商品名称/属性" width="240" align="center">
    ...
    <!-- :header-cell-style="{background:'#f2f2f2',color:'#606266','border-bottom': '1px rgb(103, 194, 58) solid'}"<el-table-column label="商品名称/属性" align='center' width="240" prop="productName"></el-table-column>
      ...
      <el-table ref="productHistoryTable"  
        ...
        <el-table-column label="操作" width="160" align="center">
          <template slot-scope="scope">
            ...
            <el-button size="mini"
                type="text"
                @click="handleUpdate(scope.$index, scope.row)">回复</el-button>
            <el-button size="mini"
                type="text"
