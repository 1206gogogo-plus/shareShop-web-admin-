  ...
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productSaleForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="商品推荐：">
        ...
        <span style="margin-left: 10px;margin-right: 10px">特卖</span>
        <el-switch
          v-model="value.recommandStatus"
          :active-value="1"
          :inactive-value="0">
        </el-switch>
        <span style="margin-left: 10px;margin-right: 10px">季节</span>
        <el-switch
          v-model="value.recommandStatus"
          :active-value="1"
          :inactive-value="0">
        </el-switch>
        <span style="margin-left: 10px;margin-right: 10px">品牌</span>
        <el-switch
          v-model="value.recommandStatus"
          :active-value="1"
          :inactive-value="0">
      ...
      <el-form-item label="使用说明：">
        <el-input v-model="value.detailDesc" type="textarea"></el-input>
      </el-form-item>
