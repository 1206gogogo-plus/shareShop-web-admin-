                           ...
                           <!-- <el-tag>  -->
                            ...
                            <div><!--values是选中的多选框-->
                                <el-checkbox-group v-model="values">
                                    <el-checkbox v-for="(item,key,index) in AttrValues" :key="index" :label="item.label" 
                ...
                for (let i = 0; i < list.length; i++) {
                    ...
                    // for(let j = 0; j < list[i].attributeValues.length; j++)
                        for (let j = 0; j < list[i].attributeValues.length; j++) {
                            ...
                            //alert(this.list[i].attributeValues[j].attrValue);
                        }
                        alert(AttrValue);
                         
                        //现在AttrValue已经被分成3个属性一组了，怎么存储起来
                        for(let j = 0; j < list[i].attributeValues.length; j++)
                        {
                            this.AttrValues=AttrValue;
                            //this.AttrValues.push(AttrValue[j]);
                        }
